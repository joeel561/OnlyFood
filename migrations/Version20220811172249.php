 ...
 */
final class Version20220811172249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient_quantity_recipe (ingredient_quantity_id INT NOT NULL, recipe_id INT NOT NULL, INDEX IDX_4DE1F8CAC6F88465 (ingredient_quantity_id), INDEX IDX_4DE1F8CA59D8A214 (recipe_id), PRIMARY KEY(ingredient_quantity_id, recipe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE ingredient_quantity_recipe ADD CONSTRAINT FK_4DE1F8CAC6F88465 FOREIGN KEY (ingredient_quantity_id) REFERENCES ingredient_quantity (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ingredient_quantity_recipe ADD CONSTRAINT FK_4DE1F8CA59D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) ON DELETE CASCADE');
