            ...
            <div class="weekly-plan-wrapper accordion" id="weeklyPlanAccordionParent" v-else>
                ...
                <div class="modal fade weekly-plan-modal" id="createShoppingListModal" tabindex="-1" aria-labelledby="createShoppingListModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content modal-weekly-shopping-list-content modal-login-content">
                            ...
                            <p>
                                If you click on create the current shopping list will be overwritten. Do you want to continue?
                            </p>
                            </div>
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn" data-bs-dismiss="modal" aria-label="Close">Close</button>
                                <button type="button" class="btn btn-primary" aria-label="Create" data-bs-dismiss="modal" @click="createShoppingList()">Create</button>
                            </div>
                            <div class="bg-orange">
            ...
            createShoppingList() {
                if (this.weeklyPlans.length == 0) {
                    ...
                    this.weeklyPlans.forEach(weeklyPlan => {
                        weeklyplanIngredients.push(weeklyPlan.recipe.ingredients);
                    });
